...
- Atomic Design は UI コンポーネントの設計手法
- コンポーネントを 5 つの階層（Atoms, Molecules, Organisms, Templates, Pages）に分けて設計
- 再利用性の高いコンポーネントを作成し、開発効率と保守性を向上させる
- 実務では Atomic Design の考え方を参考にしつつ、プロジェクトの規模や要件に応じて柔軟にコンポーネント設計を行うことが重要で、Atoms や Organisms のみを使用する場合もある
